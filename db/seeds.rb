...
Review.create(movie_id: 1, user_id: 2, review: "Pre-packaged dog crap, a dumb movie made by dull-witted adults who clearly believe that just because some viewers currently reside at the lower end of the age spectrum, they don't deserve better.", date_posted: DateTime.now)
...
Review.create(movie_id: 3, user_id: 1, review: "Among the great strengths of The Dark Knight is the way it combines hardboiled naturalism with the kind of stunts and setpieces you expect in summer blockbusters.", date_posted: DateTime.now)
